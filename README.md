...
- Clear medication guidance (what each medicine is for and how to take it)
...
- International students, migrants, and others unfamiliar with local healthcare systems

## MVP Scope

The MVP focuses on one clear flow:

1. The user pastes medical text (for example, discharge notes).
2. The app returns a structured output with five sections:
...
- Text input for discharge notes or treatment instructions
- Plain-English summary
- Short action checklist
- Medication explanation section
- Red-flag escalation section
- Safety disclaimer that the tool supports understanding and does not diagnose
...
- Recommends rest and fluids
- Separates urgent warning signs clearly
- Optionally asks a teach-back question (for example: when to seek urgent help)
...
- Identifying important actions
- Reorganizing information around patient needs
- Adapting output for clearer comprehension
